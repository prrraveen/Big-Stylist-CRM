    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('marital_status', models.CharField(default=b'S', max_length=1, choices=[(b'M', b'married'), (b'S', b'Single')])),
                ...
                ('availability', models.CharField(default=b'A', max_length=2, choices=[(b'A', b'Available'), (b'NA', b'Single')])),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
        ...
        migrations.AddField(
            ...
            name='services',
            field=models.ManyToManyField(to='agent.Service', blank=True),
        ),
    ]
